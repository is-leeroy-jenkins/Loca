...
<img src="https://img.shields.io/badge/Streamlit-Loca%20LLaMa-FF4B4B?logo=streamlit&logoColor=white" alt="Streamlit App">
</a>
</td>
...
<img src="https://img.shields.io/badge/Palantir-Loca%20LLaMa-101113?logo=palantir&logoColor=white" alt="Palantir Repo">
</a>
</td>
...
<img src="https://img.shields.io/badge/Databricks-Loca%20LLaMa-FF3621?logo=databricks&logoColor=white" alt="Databricks Notebook">
</a>
</td>
</tr>
</table>
...
| LLM   | Base              | Size |   Family     | Primary Role                                                                                                                                               | Configured Modes                                                                                           |
| ---------- | ----------------------- | ---- | -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| [Bro](https://huggingface.co/leeroy-jankins/bro)   | `gemma-3-4b-it`         | 4B   | Gemma   | Balanced local assistant for text, document, prompt, semantic, and data workflows.                                                                         | Text Generation, Document Q&A, Semantic Search, Prompt Engineering, Data Management                        |
| [Gipity](https://huggingface.co/leeroy-jankins/gipity) | `gpt-oss-20b`           | 21B  | GPT-OSS | Larger reasoning-oriented local assistant for text, document, semantic, function-calling, and guarded web-context workflows.                               | Text Generation, Document Q&A, Semantic Search, Prompt Engineering, Data Management                        |
| [Buddy](https://huggingface.co/leeroy-jankins/buddy) | `gemma-3-270m-it`       | 0.3B | Gemma | Compact local assistant using conservative retrieval defaults for Document Q&A and Semantic Search.                                                        | Text Generation, Document Q&A, Semantic Search, Prompt Engineering, Data Management                        |
| [Boo](https://huggingface.co/leeroy-jankins/boo)    | `Phi-4-mini-instruct`   | 3.8B | Phi     | Lightweight reasoning assistant with strong text and document workflow support.                                                                            | Text Generation, Document Q&A, Semantic Search, Prompt Engineering, Data Management                        |
| [Jimi](https://huggingface.co/leeroy-jankins/jimi)   | `gemma-4-E4B-it`        | 4B   | Gemma   | Multimodal-capable local assistant for text, image, audio, document, semantic, prompt, data, thinking, coding, and function-call workflows.                | Text Generation, Images API, Audio API, Document Q&A, Semantic Search, Prompt Engineering, Data Management |
| [Leeroy](https://huggingface.co/leeroy-jankins/leeroy) | `Llama-3.2-1B-Instruct` | 1B   | Llama   | Small instruction-tuned text assistant for dialogue, summarization, retrieval, and prompt workflows.                                                       | Text Generation, Document Q&A, Semantic Search, Prompt Engineering, Data Management                        |
| [Nisty](https://huggingface.co/leeroy-jankins/nisty)  | `gemma-4-E4B-it`        | 4B   | Gemma   | Governance/document-oriented multimodal assistant for text, image, audio, document, semantic, prompt, data, thinking, coding, and function-call workflows. | Text Generation, Images API, Audio API, Document Q&A, Semantic Search, Prompt Engineering, Data Management |

...
| Assistant  | Hugging Face                                                                                                                                       | Base Model              | Size | Family  | Primary Role                                                                                                                                               | Configured Modes                                                                                           |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- | ---- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| **Bro**    | [![HuggingFace](https://huggingface.co/datasets/huggingface/badges/resolve/main/model-on-hf-sm.svg)](https://huggingface.co/leeroy-jankins/bro)    | `gemma-3-4b-it`         | 4B   | Gemma   | Balanced local assistant for text, document, prompt, semantic, and data workflows.                                                                         | Text Generation, Document Q&A, Semantic Search, Prompt Engineering, Data Management                        |
| **Gipity** | [![HuggingFace](https://huggingface.co/datasets/huggingface/badges/resolve/main/model-on-hf-sm.svg)](https://huggingface.co/leeroy-jankins/gipity) | `gpt-oss-20b`           | 21B  | GPT-OSS | Larger reasoning-oriented local assistant for text, document, semantic, function-calling, and guarded web-context workflows.                               | Text Generation, Document Q&A, Semantic Search, Prompt Engineering, Data Management                        |
| **Buddy**  | [![HuggingFace](https://huggingface.co/datasets/huggingface/badges/resolve/main/model-on-hf-sm.svg)](https://huggingface.co/leeroy-jankins/buddy)  | `gemma-3-270m-it`       | 0.3B | Gemma 3 | Compact local assistant using conservative retrieval defaults for Document Q&A and Semantic Search.                                                        | Text Generation, Document Q&A, Semantic Search, Prompt Engineering, Data Management                        |
| **Boo**    | [![HuggingFace](https://huggingface.co/datasets/huggingface/badges/resolve/main/model-on-hf-sm.svg)](https://huggingface.co/leeroy-jankins/boo)    | `Phi-4-mini-instruct`   | 3.8B | Phi     | Lightweight reasoning assistant with strong text and document workflow support.                                                                            | Text Generation, Document Q&A, Semantic Search, Prompt Engineering, Data Management                        |
| **Jimi**   | [![HuggingFace](https://huggingface.co/datasets/huggingface/badges/resolve/main/model-on-hf-sm.svg)](https://huggingface.co/leeroy-jankins/jimi)   | `gemma-4-E4B-it`        | 4B   | Gemma   | Multimodal-capable local assistant for text, image, audio, document, semantic, prompt, data, thinking, coding, and function-call workflows.                | Text Generation, Images API, Audio API, Document Q&A, Semantic Search, Prompt Engineering, Data Management |
| **Leeroy** | [![HuggingFace](https://huggingface.co/datasets/huggingface/badges/resolve/main/model-on-hf-sm.svg)](https://huggingface.co/leeroy-jankins/leeroy) | `Llama-3.2-1B-Instruct` | 1B   | Llama   | Small instruction-tuned text assistant for dialogue, summarization, retrieval, and prompt workflows.                                                       | Text Generation, Document Q&A, Semantic Search, Prompt Engineering, Data Management                        |
| **Nisty**  | [![HuggingFace](https://huggingface.co/datasets/huggingface/badges/resolve/main/model-on-hf-sm.svg)](https://huggingface.co/leeroy-jankins/nisty)  | `gemma-4-E4B-it`        | 4B   | Gemma   | Governance/document-oriented multimodal assistant for text, image, audio, document, semantic, prompt, data, thinking, coding, and function-call workflows. | Text Generation, Images API, Audio API, Document Q&A, Semantic Search, Prompt Engineering, Data Management |
...
## 📜 [MIT License](https://github.com/is-leeroy-jenkins/Loca/blob/main/LICENSE.txt)

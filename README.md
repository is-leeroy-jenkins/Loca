...
| ![Boo](https://huggingface.co/leeroy-jankins/buddy) | `gemma-3-270m-it`       | 0.3B | Gemma 3 | Compact local assistant using conservative retrieval defaults for Document Q&A and Semantic Search.                                                        | Text Generation, Document Q&A, Semantic Search, Prompt Engineering, Data Management                        |
